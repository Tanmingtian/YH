...
//RCC_MCO1Config(RCC_MCO1Source_PLLCLK, RCC_MCO1Div_1);
	if(status==ON)
	{
		...
		TIM_OCInitStructure.TIM_Pulse = 2250;
  	...
  	TIM5->ARR=Speedup[0];
		...
		//¼ÆÊýÆ÷ÉÏÒçÖÐ¶ÏÉè¶¨
		TIM_ClearFlag(TIM5, TIM_FLAG_Update);/*Çå³ý¸üÐÂ±êÖ¾Î»*/
		TIM_ARRPreloadConfig(TIM5, DISABLE);/*Ô¤×°ÔØ¼Ä´æÆ÷µÄÄÚÈÝ±»Á¢¼´´«ËÍµ½Ó°×Ó¼Ä´æÆ÷ */
		//Æô¶¯¶¨Ê±Æ÷
